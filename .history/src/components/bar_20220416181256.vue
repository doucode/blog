        ...
        >
            ...
            <el-form :model="form">
              ...
              <el-form-item :label-width="formLabelWidth">
                <el-input
                  ...
                  placeholder="密码"
                  :show-password="form.loginShowPwd"
          ...
          >
            ...
            <el-form :model="form">
              ...
              <el-form-item :label-width="formLabelWidth">
                <el-input
                  v-model="form.registerInviteCode"
                  placeholder="邀请码"
          ...
          >
            ...
            <el-menu-item
              route="/admins/userManage"
              index="4-4"
              v-if="this.$store.state.roles.indexOf('ADMIN') > -1"
            >
              &nbsp;&nbsp;&nbsp;
...
export default {
  ...
  methods: {
    ...
    userLogin () { // 登录方法
      if (this.form.telephone.length <= 0 || this.form.loginPwd.length <= 0) {
        this.$message({
          message: '字段不完整',
          type: 'error'
        })
      ...
      user.login(this.form.telephone, this.form.loginPwd).then(response => {
        this.form.loginPwd = ''
    ...
    userRegister () { // 用户注册
      ...
      //
      if (this.form.registerName.length <= 0 || this.form.registerPwd.length <= 0 || this.form.registerConfirmPwd.length <= 0 ||
          this.form.registerMail.length <= 0 || this.form.registerInviteCode.length <= 0) {
        this.$message({
          message: '字段不符合规范',
          type: 'error'
        })
      ...
      user.register(this.form.registerName, this.form.telephone, this.form.registerPwd, this.form.registerInviteCode, this.form.registerMail).then(res => {
        this.$message({
          message: '注册成功',
          type: 'success'
        })
