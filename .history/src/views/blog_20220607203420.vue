  ...
  <div>
    <el-card id="blog">
      <el-link
        :underline="false"
        @click="back()"
      ><i class="el-icon-back">Back</i></el-link>
      ...
      <div style="text-align: center">
        <p>
          <span class="el-icon-time hidden-xs-only">&nbsp;{{time=blog.publishedAt.substring(0,10)+' '+blog.publishedAt.substring(11,16)}}</span>
      ...
      <!-- <div
        ...
        v-if="userReward!=undefined&&userReward!==null"
      >
        <br />
        <el-popover
          placement="bottom"
        ...
        <el-button
          type="text"
          :class="[like?'el-tyson-good-fill':'el-tyson-good']"
          @click="likeThis"
        >
      ...
      >
        ...
        <div
          style="width: 50%;margin-left: 2.5%;padding-top: 2%"
          v-if="getStoreName()!=''"
        >
          <el-input
            v-model="discussBody"
      ...
      <!-- <div
        ...
        >
          ...
          >
            ...
            <span
              style="color: #909399;margin-left: 50px"
              class="el-icon-time"
            >{{getTime(discuss.time)}}</span>
            <el-button
              type="text"
              style="margin-left: 5%"
            ...
            <el-button
              type="text"
              style="margin-left: 1%"
              @click="sendReply(discuss.id,null)"
              v-if="getStoreName()!=''&&replyFlag"
            >回复
            </el-button>
      ...
      <!-- <p
            v-if="!(typeof(discuss.replyList) == 'undefined') && discuss.replyList.length>0"
            v-for="reply in discuss.replyList"
            style="margin: -5px"
            @mouseenter="pEnter()"
            @mouseleave="pLeave()"
          >
            ...
            <el-button
              type="text"
              v-if="!(typeof(reply.reply) == 'undefined') && reply.reply !== null"
            >
            ...
            <el-button
              type="text"
              style="margin-left: 1%"
              @click="sendReply(discuss.id,reply.id)"
              v-if="getStoreName()!=''&&replyFlag"
            >回复
            </el-button>
          </p>
